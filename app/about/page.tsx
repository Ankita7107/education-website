...
const values = [
  {
    icon: Target,
    title: "Our Mission",
    desc: "To democratize hiring in India by providing affordable, AI-powered recruitment solutions that connect the right talent with the right opportunity — every time.",
    color: "text-blue-600",
    bg: "bg-blue-50",
  },
  {
    icon: Eye,
    title: "Our Vision",
    desc: "To become India's most trusted and largest recruiter network, spanning 100+ cities, powered by AI and driven by verified data.",
  ...
  },
  {
    icon: Heart,
    title: "Our Values",
    desc: "Transparency, verified quality, affordability, and candidate dignity. We believe every job seeker deserves a fair chance and every employer deserves genuine candidates.",
